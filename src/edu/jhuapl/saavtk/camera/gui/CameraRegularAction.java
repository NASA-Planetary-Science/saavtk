 ...
 * @author lopeznr1
 */
public class CameraRegularAction extends AbstractAction implements HierarchyListener
{
	// Constants
	private static final String Title = "Camera: Regular";
	 ...
	 */
	public CameraRegularAction(ViewManager aViewManager)
	{
		super(Title);

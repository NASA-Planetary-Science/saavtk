...
public class RendererWithCameraInterpolation extends JPanel implements
...
//    		return Math.atan((interpFac-0.5)*20.)/Math.PI+1/2.;
    ...
    public RendererWithCameraInterpolation(final ModelManager modelManager, StatusBar statusBar)
    {
        this(modelManager);
        this.statusBar=statusBar;
    }

    public RendererWithCameraInterpolation(final ModelManager modelManager)
    {

...
public class StereoRenderCanvas extends vtksbmtJoglCanvas
{
    ...
    /*
     * vtkRenderer lftRenderer=new vtkRenderer(); vtkRenderer rgtRenderer=new
     * vtkRenderer(); vtkRenderWindow lftRenderWindow=new vtkRenderWindow();
    ...
    public StereoRenderCanvas(vtkActor testActor)
    {
         ...
         * rgtRenderWindow.SetStereoTypeToRight(); recomputeSize(); //
         * lftRenderer.AddActor(testActor); rgtRenderer.AddActor(testActor);
    ...
    /*
     * private void recomputeSize() { this.w=getRenderWindow().GetSize()[0];
     * this.h=getRenderWindow().GetSize()[1]; lftRenderWindow.SetSize(w/2,h); //
     * might need to adjust width to avoid buffer overflow
    ...
    {
        /*
         * lftRenderWindow.Render(); rgtRenderWindow.Render();
         * System.out.println(lftRenderWindow.GetSize()[0]+" "+lftRenderWindow.GetSize()
         * [1]); lftRenderWindow.GetRGBACharPixelData(0, 0,
         * lftRenderWindow.GetSize()[0]-1, lftRenderWindow.GetSize()[1]-1, 1, lftData);
         * rgtRenderWindow.GetRGBACharPixelData(0, 0, rgtRenderWindow.GetSize()[0]-1,
         * rgtRenderWindow.GetSize()[1]-1, 1, rgtData);

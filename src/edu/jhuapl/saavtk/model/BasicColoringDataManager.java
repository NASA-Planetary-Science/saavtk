...
public class BasicColoringDataManager implements ColoringDataManager {
	 ...
	 * the serializer.
	 * 
	 * @param serializerVersion
	 *            the version of the serializer that will be used to write and read
	 *            the coloring metadata.
	...
	public ColoringData get(String name, int numberElements) {
		...
		if (result == null) {
			throw new IllegalArgumentException(
					"Cannot find coloring for " + name + " (" + numberElements + " elements)");
		}
		return result;
	}
	...
	public final void add(ColoringData data) {
		...
		if (dataTable.contains(name, numberElements)) {
			throw new IllegalArgumentException(
					"Duplicated coloring for " + name + " (" + numberElements + " elements)");
		}
	 ...
	 * 
	 * @param oldName
	 *            the name of the old coloring to replace
	 * @param newData
	 *            the new coloring data object
	 * @throws IllegalArgumentException
	 *             if there is no coloring with the given name and the same
	 *             resolution as the supplied new coloring object

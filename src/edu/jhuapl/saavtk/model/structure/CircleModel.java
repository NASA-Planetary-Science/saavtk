...
/**
 * Model of circle structures drawn on a body. This class adds the ability to
 * create a new circle by simply clicking any 3 points on the perimeter of the
 * circle. The circle is formed by using VTK's vtkTriangle::Circumcircle
 * function.
 */
public class CircleModel extends AbstractEllipsePolygonModel
{
	...
	public CircleModel(SceneChangeNotifier aSceneChangeNotifier, StatusNotifier aStatusNotifier,
	...
	/**
	 * Adds a new point on the perimeter of the circle. When the point count equals
	 * 3, a circle is created and the intermediate points are deleted.
	 *
	 * @param pt
	 * @return
	 */
	public boolean addCircumferencePoint(double[] pt)
	{
		...
		if (numPoints < 2)
		{
			...
			refSmallBody.shiftPolyLineInNormalDirection(activationPolyData, getOffset());

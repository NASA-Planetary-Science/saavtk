 ...
 */
public class SmallBodyCubes2
{
//    private BoundingBox boundingBox;
//    public List<BoundingBox> allCubes = new ArrayList<BoundingBox>();
    private final double cubeSize;
    private final double buffer;
    private RecursiveBoundingBox rBoundingBox;
...
//            removeEmptyCubes(smallBodyPolyData);
    ...
    private void initialize(vtkPolyData smallBodyPolyData)
    {
        ...
        BoundingBox box = new BoundingBox(smallBodyPolyData.GetBounds());
//        System.out.println("SmallBodyCubes2: initialize: largest side " + box.getLargestSide());
//        System.out.println("SmallBodyCubes2: initialize: cube size " + cubeSize);
//        for (double bound : smallBodyPolyData.GetBounds()) System.out.println("SmallBodyCubes2: initialize: bound is " + bound);
        rBoundingBox = new RecursiveBoundingBox(smallBodyPolyData.GetBounds(), box.getLargestSide());
...
//
//        System.out.println("SmallBodyCubes: initialize: num cubes " + numCubesX + " " + numCubesY + " " + numCubesZ);
//        
...
//    }
    ...
    public Vector<String> getIntersectingCubes(vtkPolyData polydata)
    {
    	return rBoundingBox.findIntersectionsInChildren(polydata);
    }

...
public abstract class GenericImage implements Image
{
...
//	ImageKey key;
	...
	public GenericImage(vtkImageData imageData, vtkPolyData targetSurface, Projection projection)//, ImageKey key)
	{
		this(imageData, targetSurface, projection, /*key,*/ new PassThroughImageDataFilter());
	}
	
	public GenericImage(vtkImageData imageData, vtkPolyData targetSurface, Projection projection, /*ImageKey key,*/ ImageDataFilter preFilter)
	{
